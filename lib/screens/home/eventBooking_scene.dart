...
class EventBookingScene extends StatelessWidget {
  final Store<AppState> store;

  EventBookingScene(this.store);
    ...
    return NestedScrollView(
      ...
      body: ListView(
        ...
        children: <Widget>[
          ...
          buildAgeGroupSubTitle(),
          buildAgeGroupList(context, viewModel),
          buildPriceSubtitle(),
          buildPriceList(context, viewModel),
        ],
      ),
    );
  }
  ...
  Widget buildHeaderNameAndLocation() {
    controller.text = "Summer Sports Camp";
...
//        crossAxisAlignment: CrossAxisAlignment.start,
  ...
  Widget buildPriceList(BuildContext context, _ViewModel viewModel) {
    return Padding(
      padding: const EdgeInsets.only(left: 25.0, right: 25.0),
      child: Container(
        height: 60.0,
